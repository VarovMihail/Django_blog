...
from api.v1.user_profile.views import ChangePassAPIView, AvatarUpdateView, FillOutView, AllUsersAPIView, UserInfoAPIView, ChangeDataAPIView
...
urlpatterns = [
    ...
    path('change-data/', ChangeDataAPIView.as_view(), name='api_change_data'),
